...
<body>
    ...
    @if ($umroh->isnotempty())
        <section class="px-4 md:px-12 py-12">
            <div class=" flex flex-col lg:flex-row lg:justify-center items-center mb-8 mt-16">
                <h1 class="text-3xl md:text-5xl text-black font-bold text-center md:text-start mb-4">Paket Umroh
                </h1>
            </div>
                ...
                @foreach ($umroh as $umroh_item)
                    <div>
                        <a href="{{ route('detail-umroh', ['id' => $umroh_item->id]) }}"
                            ...
                            <img src="{{ asset('storage/' . $umroh_item->image[0]) }}"

...
<body>
    ...
    <section class="xl:h-screen 2xl:h-96 flex flex-col justify-center items-center w-screen">
        <div id="default-carousel" class="mt-24 w-full xl:hidden" data-carousel="static">
            <!-- Carousel wrapper -->
            <div class="relative h-56 overflow-hidden rounded-lg md:h-96 xl:hidden">
                <!-- Item 1 -->
                <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                    <img src="{{ Vite::asset('resources/images/lp-main/haji/detail-catalog-dummy-1.png') }}"
            ...
            <button type="button"
                ...
                data-carousel-prev>
                <span
                    class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-red-primary dark:bg-red-primary group-hover:bg-red-primary dark:group-hover:bg-red-300 group-focus:ring-4 group-focus:ring-red-300 dark:group-focus:ring-red-300 group-focus:outline-none">
        ...
        <div class="gap-4 hidden xl:flex justify-around items-center flex-row">
            <div class="w-64 h-96 bg-white rounded-xl p-2 mt-16 shadow-2xl" onclick="openModal('image1')">
                <img class="rounded-xl" src="{{ Vite::asset('resources/images/lp-main/haji/detail-catalog-dummy-1.png') }}" alt="">
            </div>
    ...
    <section class="px-2 mt-8 md:mt-22 py-12 md:px-14">
        <h1
        ...
        <ul class="list-disc list-outside px-12 font-semibold">
            <li class="pb-4">Tanpa Antrian Panjang: Dengan Visa Furodha, Anda langsung berangkat tanpa harus menunggu
                antrean
                reguler.</li>
            <li class="pb-4">Pendampingan Profesional: Dibimbing oleh Muthawwif berpengalaman yang akan membantu
                kelancaran ibadah
                Anda.</li>
            <li class="pb-4">Perjalanan Nyaman: Akomodasi premium, fasilitas modern, dan layanan yang dirancang
                khusus
                untuk
                kenyamanan Anda.</li>
        </ul>
    ...
    <section class="px-8 md:px-16">
        <div class="flex flex-col justify-between items-center md:items-start md:flex-row md:">
            <div class="">
                ...
                <h3 class="text-md font-bold mb-2">Sudah Termasuk</h3>
                <ul class="list-disc list-outside px-6 font-semibold">
                    <li class="pb-4 md:pb-2">Tiket pesawat PP (Indonesia - Saudi Arabia).</li>
                    <li class="pb-4 md:pb-2">Visa Furodha tanpa antrean.</li>
                    <li class="pb-4 md:pb-2">Maktab Furodha untuk kenyamanan ibadah.</li>
                </ul>
            </div>

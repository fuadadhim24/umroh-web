...
<body>
    ...
    <section class="h-screen py-14  flex justify-center items-center">
        <div class="w-full h-full md:mx-12 mt-16 rounded-3xl mx-2"
            style="background-image: url('{{ asset('resources/images/lp-main/umroh/section-hero.png') }}'); background-size: cover; background-position: center;">
    ...
    <section class="px-8 md:px-24 lg:px-48 xl:px-72 md:mt-20 md:mb-20">
        ...
        <div class="lg:px-24">
            <h4 class="text-center font-semibold">El Aqsho Group hadir untuk mewujudkan perjalanan ibadah umroh Anda
                ...
                menjadi pilihan terbaik untuk perjalanan ibadah Anda.</h4>
        </div>
    </section>
    <section class="md:px-24 mt-8 md:mt-22 py-12">
        ...
        <div class="lg:grid lg:grid-cols-3 lg:gap-8">
            <div class="my-2 lg:my-0 flex flex-col items-center mb-8 ">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/umroh/ic-excess-1.png') }}"
                        alt="">
            ...
            <div class="my-2 lg:my-0 flex flex-col items-center mb-8">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/umroh/ic-excess-2.png') }}"
                        alt="">
            ...
            <div class="my-2 lg:my-0 flex flex-col items-center">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/umroh/ic-excess-3.png') }}"
                        alt="">
        ...
        <div class="lg:grid lg:grid-cols-3 lg:gap-4 mt-8">
            <div class="my-2 lg:my-0 flex flex-col items-center mb-8">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/umroh/ic-excess-4.png') }}"
                        alt="">
            ...
            <div class="my-2 lg:my-0 flex flex-col items-center mb-8">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/umroh/ic-excess-5.png') }}"
                        alt="">
            ...
            <div class="my-2 lg:my-0 flex flex-col items-center">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/umroh/ic-excess-6.png') }}"
                        alt="">

                </div>
                <h3 class="font-bold text-dark-red-primary mt-4 text-lg">Pelayanan Ramah dan Profesional</h3>
                <p class="text-center  mt-2 mx-4">Tim kami siap melayani Anda dengan sepenuh hati, dari awal
                    pendaftaran
                    ...
                    @foreach ($visibleUmroh as $umroh_item)
                        <div>
                            <a href="{{ route('detail-umroh', ['id' => $umroh_item->id]) }}"
                                ...
                                <img src="{{ asset('storage/' . $umroh_item->image[0]) }}" loading="lazy"
                                    alt="Photo by Austin Wade"
                                    class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                            </a>
                            <h2 class="text-center font-semibold text-xl mt-4">Paket {{ $umroh_item->title }}</h2>
                            <h2 class="text-center font-semibold text-sm">Harga Rp. {{ number_format($umroh_item->price, 0, ',', '.') }}</h2>
                        </div>
                    @endforeach
                </div>
            </section>

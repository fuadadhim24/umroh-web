...
<body>
    <nav class="bg-white shadow-2xl dark:bg-gray-900 fixed rounded-full mt-4 mb-4 inset-x-0 xl:mx-56 sm:mx-24 md:mx-36 mx-4 z-50">
                ...
                <div class="grid sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-4">
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div
                                class="absolute top-1/2 h-48 left-1/2 -translate-x-1/2 -translate-y-3/4 w-full  shadow-lg rounded-lg p-6 flex flex-col items-center justify-center z-10 bg-gradient-to-b from-dark-red-primary to-dark-red-second">
                                <!-- Konten utama -->

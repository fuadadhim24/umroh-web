            ...
            <div class="flex flex-col lg:flex-row lg:gap-4 items-center">
                ...
                <div class="flex flex-col gap-y-6  p-4">
                    <div class="my-2 lg:my-0 flex flex-col items-center">
                        <div class="rounded-full h-28 w-28 shadow-xl bg-white flex justify-center p-6">
                            <img class="object-contain"
                                src="{{ asset('resources/images/lp-main/badal/ic-excess-1.png') }}" alt="">
                        </div>
                    ...
                    <div class="my-2 lg:my-0 flex flex-col items-center">
                        <div class="rounded-full h-28 w-28 shadow-xl bg-white flex justify-center p-6">
                            <img class="object-contain"
                                src="{{ asset('resources/images/lp-main/badal/ic-excess-2.png') }}" alt="">
                        </div>
                ...
                <div class="flex flex-col gap-y-6  p-4">
                    <div class="my-2 lg:my-0 flex flex-col items-center mb-8">
                        <div class="rounded-full h-28 w-28 shadow-xl bg-white flex justify-center p-6">
                            <img class="object-contain"
                                src="{{ asset('resources/images/lp-main/badal/ic-excess-3.png') }}" alt="">
                        </div>
                    ...
                    <div class="my-2 lg:my-0 flex flex-col items-center ">
                        <div class="rounded-full h-28 w-28 shadow-xl bg-white flex justify-center p-6">
                            <img class="object-contain"
                                src="{{ asset('resources/images/lp-main/badal/ic-excess-4.png') }}" alt="">
                        </div>
                            ...
                            <a href="#">
                                <div
                                    ...
                                    <div>
                                        ...
                                        <h3 class="font-semibold text-white md:text-xl lg:text-xl">Harga</h3>
                                        <h3 class="font-semibold text-white md:text-xl lg:text-xl">Rp. {{ number_format($badal[1]->harga_paket, 0, ',', '.') }}</h3>
                                    </div>

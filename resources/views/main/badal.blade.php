                        ...
                        <a href="#"
                            ...
                            <div
                                ...
                                <div class="w-5/6 h-5/6  bg-dark-red-primary rounded-full flex justify-center items-center">
                                    <img src="{{ Vite::asset('resources/images/lp-main/badal/ic_step1.png') }}" alt="" srcset="" class="w-12 h-12">
                                </div>
                            </div>
                            <div
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div
                                class="absolute top-24 left-1/2 -translate-x-1/2 -translate-y-24 w-24 h-24 bg-white   shadow-lg rounded-full z-20 flex items-center justify-center">
                                <div class="w-5/6 h-5/6  bg-dark-red-primary rounded-full flex justify-center items-center">
                                    <img src="{{ Vite::asset('resources/images/lp-main/badal/ic_step2.png') }}" alt="" srcset="" class="w-12 h-12">
                                </div>
                            </div>
                            <div
                                class="absolute top-1/2 h-64 left-1/2 -translate-x-1/2 -translate-y-28 w-full  shadow-lg rounded-lg p-6 flex flex-col items-center justify-center z-10 bg-gradient-to-b from-dark-red-primary to-dark-red-second">
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div
                                class="absolute top-24 left-1/2 -translate-x-1/2 -translate-y-24 w-24 h-24 bg-white   shadow-lg rounded-full z-20 flex items-center justify-center">
                                <div class="w-5/6 h-5/6  bg-dark-red-primary rounded-full flex justify-center items-center">
                                    <img src="{{ Vite::asset('resources/images/lp-main/badal/ic_step3.png') }}" alt="" srcset="" class="w-12 h-12">
                                </div>
                            </div>
                            <div
                                class="absolute top-1/2 h-64 left-1/2 -translate-x-1/2 -translate-y-28 w-full  shadow-lg rounded-lg p-6 flex flex-col items-center justify-center z-10 bg-gradient-to-b from-dark-red-primary to-dark-red-second">
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div
                                class="absolute top-24 left-1/2 -translate-x-1/2 -translate-y-24 w-24 h-24 bg-white   shadow-lg rounded-full z-20 flex items-center justify-center">
                                <div class="w-5/6 h-5/6  bg-dark-red-primary rounded-full flex justify-center items-center">
                                    <img src="{{ Vite::asset('resources/images/lp-main/badal/ic_step4.png') }}" alt="" srcset="" class="w-12 h-12">
                                </div>
                            </div>
                            <div
                                class="absolute top-1/2 h-64 left-1/2 -translate-x-1/2 -translate-y-28 w-full  shadow-lg rounded-lg p-6 flex flex-col items-center justify-center z-10 bg-gradient-to-b from-dark-red-primary to-dark-red-second">

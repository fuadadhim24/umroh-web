                        ...
                        <a href="#"
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <img src="{{ Vite::asset('resources/images/lp-main/badal/ic_step1.png') }}"
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div
                                ...
                                <div
                                    class="w-5/6 h-5/6  bg-dark-red-primary rounded-full flex justify-center items-center">
                                    <img src="{{ Vite::asset('resources/images/lp-main/badal/ic_step2.png') }}"
                                        alt="" srcset="" class="w-12 h-12">
                                </div>
                            </div>
                            <div
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div
                                ...
                                <div
                                    class="w-5/6 h-5/6  bg-dark-red-primary rounded-full flex justify-center items-center">
                                    <img src="{{ Vite::asset('resources/images/lp-main/badal/ic_step3.png') }}"
                                        alt="" srcset="" class="w-12 h-12">
                                </div>
                            </div>
                            <div
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div
                                ...
                                <div
                                    class="w-5/6 h-5/6  bg-dark-red-primary rounded-full flex justify-center items-center">
                                    <img src="{{ Vite::asset('resources/images/lp-main/badal/ic_step4.png') }}"
                                        alt="" srcset="" class="w-12 h-12">
                                </div>
                            </div>
                            <div

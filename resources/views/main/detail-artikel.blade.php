...
<body>
    ...
    <section class="flex py-10 md:py-20 justify-center">
        <div class="mx-auto w-full 2xl px-4 md:px-8 ">
                    ...
                    <div class="rounded-3xl shadow-custom hover:shadow-lg transition-transform duration-300 pt-4">
                        ...
                        <div class="my-2 md:mx-14 flex flex-col md:flex-row p-4">
                            <div class="w-full md:w-full md:mr-2 text-start md:text-left">
                                ...
                                <h2 class="text-xl md:text-2xl font-semibold mb-3 text-gray-700 dark:text-gray-400">
                                    {{ $article->title }}
                                </h2>
                            ...
                            <div class="w-full md:w-1/3 flex flex-col items-center justify-center h-full space-y-1">
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    class="w-full">
                                    <p
                                        class="mb-4 inline-flex items-center px-10 py-4 justify-center text-sm font-medium text-center 
                            ...
                            <div class="rounded-3xl shadow-custom hover:shadow-lg transition-transform duration-300 mb-4">
                                <div class="mt-4 mx-4 rounded-2xl shadow-custom">
                                    ...
                                    <div class="rounded-t-lg w-full h-48 md:h-24 rounded-2xl bg-cover bg-center"
                                        style="background-image: url('{{ asset('storage/' . $article_item->image) }}');">
                                    </div>
                                </div>
                                <div class="p-4">
                                    <p
                                    ...
                                    <p class="line-clamp-3 text-sm text-gray-700">
                                        {{ $article_item->short_description }}
                                    </p>
                                    <p class="text-xs text-gray-700 mt-2">Tanggal:
                                        {{ \Carbon\Carbon::parse($article_item->created_at)->translatedFormat('d F Y') }}
                                    </p>
                                </div>
                            </div>
                        </a>
                    @empty
                        ...
                        <div class="text-center text-gray-500 flex flex-col items-center">
                            <h2 class="text-center sm:text-start text-4xl font-extrabold text-gray-800 md:text-3xl">
                                Mohon Maaf</h2>
                            <p>Tidak belum ada artikel lain yang tersedia saat ini.</p>
                        </div>
                    @endforelse
    ...
    <section class="justify-center flex">
        <div class="py-12 flex flex-col items-center">
            <img src="{{ asset('resources/images/lp-main/al-aqsha-horizontal.png') }}" class="h-14" alt="Flowbite Logo">
    ...
    <script>
        function saveToFavorite(articleId, articleTitle) {
            ...
            if (!favorites.some(favorite => favorite.id === articleId)) {
                ...
                alert('Artikel ini sudah ada di favorit.');
            }
        }

...
<body>
    ...
    <section class="px-24 mt-8 md:mt-22 py-12">
        ...
        <div class="lg:grid lg:grid-cols-3 lg:gap-8">
            <div class="my-2 lg:my-0 flex flex-col items-center mb-8">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/haji/ic-excess-1.png') }}"
                        alt="">
            ...
            <div class="my-2 lg:my-0 flex flex-col items-center mb-8">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/haji/ic-excess-2.png') }}"
                        alt="">
            ...
            <div class="my-2 lg:my-0 flex flex-col items-center">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/haji/ic-excess-3.png') }}"
                        alt="">
        ...
        <div class="lg:grid lg:grid-cols-3 lg:gap-4 mt-8">
            <div class="my-2 lg:my-0 flex flex-col items-center mb-8">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/haji/ic-excess-4.png') }}"
                        alt="">
            ...
            <div class="my-2 lg:my-0 flex flex-col items-center mb-8">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/haji/ic-excess-5.png') }}"
                        alt="">
            ...
            <div class="my-2 lg:my-0 flex flex-col items-center">
                <div class="rounded-full h-28 w-28 shadow-xl bg-dark-red-primary flex justify-center p-6">
                    <img class="object-contain" src="{{ asset('resources/images/lp-main/haji/ic-excess-6.png') }}"
                        alt="">

...
class PendaftaranExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths
{
    ...
    public function collection()
    {
        ...
        return $query->with('paket')->get()->map(function ($pendaftaran) {
            return [
...
public function styles(Worksheet $sheet): void // Mengubah tipe pengembalian menjadi void
{
    // // Add title
    ...
    if ($highestRow >= 5) { // Ensure there is data below the header
